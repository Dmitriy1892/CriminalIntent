...
public class CrimeListFragment extends Fragment {
    ...
    private class CrimeHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(Crime crime) {
            ...
            String date = df.format("EEEE, dd MMM, yyyy kk:mm", mCrime.getDate()).toString();
    ...
    private class CrimeAdapter extends RecyclerView.Adapter<CrimeHolder> {
        ...
        //можно сделать без метода getItemViewType() и двух макетов отражать кнопку, сделано для тренировки!!!
        @Override
        public int getItemViewType(int position) {
            int layoutId;
            if (mCrimes.get(position).isRequiresPolice()) {
                layoutId = R.layout.list_item_crime_requires_police;
            } else {
